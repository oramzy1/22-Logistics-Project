...
function Row({
  ...
  return (
    <View style={styles.row}>
      ...
      <Text numberOfLines={2} style={[styles.rowValue, valueStyle]}>
        {value}
      </Text>
    </View>
  );
      ...
      <ScrollView contentContainerStyle={styles.content}>
        ...
        <View style={styles.card}>
          ...
          {bookingId ? (
            <Row
              label="Booking ID"
              value={`#${bookingId.slice(-10).toUpperCase()}`}
            />
          ) : null}
        </View>
        ...
        <InfoBanner
          variant="info"
          text="Reminder: Please fuel the car as needed during your trip."
        />

        {outOfLGAFee && (
          <InfoBanner
            variant="basic"
            text="Trips outside Port harcourt and Obio Akpo LGAs attract additional charges."
          />
        )}
