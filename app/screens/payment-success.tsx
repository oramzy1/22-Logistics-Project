...
export default function PaymentSuccessScreen() {
  ...
  useEffect(() => {
    // Give webhook 3 seconds to process before we verify
    const timer = setTimeout(async () => {
      try {
        ...
        // Webhook may have already handled it — don't treat as hard failure
        // The booking page will show the real status
        setVerifyStatus('confirmed');
      }
    }, 3000);
