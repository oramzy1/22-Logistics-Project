...
export function BookingDetailSheet({
  ...
  const canAssign =
    ["AWAITING_DRIVER"].includes(b.status) && b.paymentStatus === "PAID";
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    {b.driver?.driverProfile && (
                      <p className="text-xs text-muted-foreground">
                        {b.driver.driverProfile.brandModel} ·{" "}
                        {b.driver.driverProfile.plateNumber}
                      </p>
                    )}
                  </div>
                </div>
