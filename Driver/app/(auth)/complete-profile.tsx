...
export default function CompleteDriverProfileScreen() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const safeUri =
        Platform.OS === "ios" ? licenseUri.replace("file://", "") : licenseUri;
      ...
      const response = await fetch(
        `https://two2-logistics-project.onrender.com/api/auth/complete-driver-profile`,
        {
          method: "POST",
      ...
      >
        <ScrollView contentContainerStyle={s.scrollContent}>
          ...
          <View style={s.infoCard}>
            ...
            <Text style={s.infoItem}>
              ③ Go online and start receiving ride requests
            </Text>
          </View>
