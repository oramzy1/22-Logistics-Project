...
const FAQS = [
  ...
  },
  {
    ...
    a: "We accept card payments and bank transfers via Paystack.",
  },
  {
...
function SupportForm({
  ...
  return (
    ...
    >
      ...
      {subjectError && (
        <Text style={s.subjectErrorText}>
          ⊘ Please describe the issue so we can help you.
        </Text>
      )}
      {subjectOpen && (
          ...
          {SUBJECTS.map((item) => (
            ...
            >
              <Text
                style={[
                  s.dropdownItemText,
                  subject === item && { color: "#0B1B2B", fontWeight: "700" },
                ]}
              >
                {item}
              </Text>
        ...
        >
          <View style={s.faqHeader}>
            ...
            <ChevronDown
              ...
              color="#6B7280"
              style={{
                transform: [{ rotate: open === i ? "180deg" : "0deg" }],
              }}
            />
          </View>
