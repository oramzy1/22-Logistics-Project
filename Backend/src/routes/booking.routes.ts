...
import {verifyPayment, reinitializePayment, endTrip, getAvailablePromos  } from '../controllers/booking.controller';
...
router.get('/promos/available', authenticate, getAvailablePromos);
