...
import { PackageId } from "./timeSlots";
...
export function BusinessHome() {
    ...
    <View style={styles.scheduleCard}>
      <View style={styles.scheduleHeaderRow}>
        <View style={styles.scheduleHeaderLeft}>
          ...
          <Text style={styles.remainingText}>3 hrs remaining</Text>
        </View>
      ...
      <View style={styles.routeContainer}>
        <View style={styles.routePoint}>
          ...
          <View style={styles.routeContent}>
            ...
            <Text style={styles.routeValue}>Port Harcourt</Text>
          </View>
        </View>
      ...
      <View style={styles.infoBox}>
        <View style={styles.infoCol}>
          ...
          <Text style={styles.infoValue}>Jan 13, 2026</Text>
          <Text style={styles.infoSubValue}>2:30pm</Text>
        </View>
        <View style={styles.infoCol}>
          <Text style={styles.infoLabel}>ESTIMATED DURATION</Text>
          <Text style={styles.infoValue}>3 HOURS</Text>
  ...
  const renderScheduleHistory = () => (
    <View style={styles.historyContainer}>
      ...
      <Text style={styles.historyDate}>Sept 2, 10:00 AM</Text>

      <View style={styles.historyRow}>
        <Text style={styles.historyRowLabel}>Ride type</Text>
        <Text style={styles.historyRowValueBlue}>10 hrs</Text>
      </View>
      <View style={styles.historyRow}>
        <Text style={styles.historyRowLabel}>Schedule date</Text>
        <Text style={styles.historyRowValueBlue}>April 08</Text>
      </View>
      <View style={styles.historyRow}>
        <Text style={styles.historyRowLabel}>Pick up location</Text>
        <Text style={styles.historyRowValueBlue}>Port Harcourt</Text>
      </View>
      <View style={styles.historyRow}>
        <Text style={styles.historyRowLabel}>Booking ID</Text>
        <Text style={styles.historyRowValueBold}>#234558984322</Text>
      </View>
      <View style={styles.historyRow}>
        <Text style={styles.historyRowLabel}>Payment status</Text>
        <Text style={styles.historyRowValueSuccess}>Successful</Text>
      </View>
      ...
      >
        ...
        <View style={styles.activityRow}>
          <View style={styles.activityCard}>
            ...
            <View style={{ flexDirection: "row", alignItems: "center" }}>
              <TrendingUp
                ...
                style={{ marginRight: 4 }}
              />
              <Text style={styles.activityIncrease}>1.5%</Text>
            </View>
          </View>
          ...
          <View style={styles.activityCard}>
            ...
            <Text style={styles.activityValue}>₦240,000</Text>
